...
- 覆盖 Home/Jarvis、Alpha Guide、First-run checklist、Source Recall、Agentic Ask、Memory Governance、Trace、Eidolia 和安全边界。
...
```text
demo/video/pska_m30_demo/dist/pska_m30_demo.mp4
demo/video/pska_m30_demo/dist/pska_m30_demo.zh.srt
demo/video/pska_m30_demo/dist/storyboard.zh.md
demo/video/pska_m30_demo/dist/voiceover.zh.md
```
