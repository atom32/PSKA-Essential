...
async function main() {
  ...
  record("Extension JS loads and contains handlers", jsAsset.response.ok
    ...
    && jsAsset.text.includes("installAnswerProofBridge()")
    && jsAsset.text.includes("PSKAMiniAnswerProofEventSource")
    && jsAsset.text.includes("automatic_after_answer_audit")
    && jsAsset.text.includes("caller: \"hermes-webui-extension\"")
