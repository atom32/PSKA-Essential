...
class HermesWebuiExtensionTests(unittest.TestCase):
    ...
    def test_extension_is_chip_only_and_uses_sidecar_bridge(self):
        ...
        self.assertIn("contextPackTechnicalWarningLine", script)
        self.assertIn("contextPackUserWarningLine", script)
        self.assertIn("相关性较低的长期记忆", script)
        self.assertIn("相关性较低的历史对话", script)
