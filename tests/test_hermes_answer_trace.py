...
class HermesAnswerTraceTests(unittest.TestCase):
    def test_records_answer_side_tool_proof_as_audit_metadata(self):
        ...
        self.assertEqual(result["proof"]["data_flow"]["data_plane"], "pska")
        self.assertTrue(result["proof"]["data_flow"]["non_blocking_after_answer_audit"])
        self.assertTrue(result["proof"]["data_flow"]["caller_provides_preview_and_hash"])
