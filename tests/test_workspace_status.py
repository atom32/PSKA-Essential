...
class WorkspaceStatusTests(unittest.TestCase):
    ...
    def test_ready_workspace_suggests_agentic_question(self):
        ...
        self.assertEqual(status["components"]["embedding"]["schema"], "pska.embedding_component_status.v1")
        self.assertFalse(status["components"]["embedding"]["runtime"]["direct_pska_dependency"])
    ...
    def test_compact_workspace_status_keeps_agent_routing_without_bulk_lists(self):
        ...
        self.assertEqual(compact["components"]["embedding"]["schema"], "pska.embedding_component_status.v1")
        self.assertFalse(compact["components"]["embedding"]["runtime"]["direct_pska_dependency"])
