...
class ProductApiTests(unittest.TestCase):
    ...
    def test_bundled_frontend_contains_reader_view(self):
        ...
        self.assertIn('showToast("Select source files, name the dataset, then run the loop.");', script)
        ...
        self.assertIn('wait_for_resumable_ask: "Track"', script)
        ...
        self.assertIn('resume_ingest_loop: "Resume Loop"', script)
        self.assertIn('track_ingestion_status: "Track"', script)
