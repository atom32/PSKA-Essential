...
alpha-acceptance-demo:
	PYTHONPATH=src $(PYTHON) scripts/run_alpha_acceptance.py $(ENV_FILE_ARG) --include-live-product-boundary-contract --include-webui-contract --include-webui-visual --include-webui-turn-bridge --include-demo-videos --timeout $${PSKA_ALPHA_DEMO_TIMEOUT:-240}
