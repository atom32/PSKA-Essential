...
TOOL_POLICY: dict[str, dict[str, Any]] = {
    ...
    "pska_chatgpt_conversations_import": {
        ...
        "removes_stale_managed_archive_files": True,
        "writes_source_registry": True,
        "writes_memory_directly": False,
        "creates_review": False,
        "embedding_required": False,
    ...
    "pska_chatgpt_conversations_import_to_hermes_history": {
        "category": "assistant",
        "access": "write",
        "durable": True,
        "control_plane": "hermes_webui_extension",
        "data_plane": "pska",
        "history_owner": "hermes_webui",
        "default_selection": "recent",
        "supported_selections": ["recent", "export_order"],
...
def memory_inflow_contract() -> dict[str, Any]:
    return {
        ...
        "paths": [
            ...
            {
                "name": "chatgpt_memory_summary_import",
                "trigger": "operator pastes or points PSKA at exported ChatGPT memory summary text",
                "api": "/api/memory/chatgpt-summary/import",
                "mcp": "pska_chatgpt_memory_summary_import",
                "requires_ready_kb_scope": False,
                "writes_memory_provider_directly": False,
                "writes_source_files": False,
                "governance": "review_candidate_only",
                "visible_review_default": True,
                "private_handling": "skip_private_entries_by_default_and_create_boundary_candidate",
                "target_when_clear": "pending_review",
                "target_when_unclear": "source_archive_only",
            },
            {
                "name": "digest_job",
...
def source_layer_contract() -> dict[str, Any]:
    return {
        ...
        "chatgpt_conversations_import": {
            "api": "/api/sources/chatgpt-conversations/import",
            "mcp": "pska_chatgpt_conversations_import",
            "target": "managed_local_source_archive",
            "writes_original_export_files": False,
            "writes_normalized_archive_files": True,
            "writes_import_report_files": True,
            "removes_stale_managed_archive_files": True,
            ...
            "creates_review": False,
            "embedding_required": False,
            "next_step": "search_or_read_archive_then_create_memory_candidates_after_review",
        },
        "chatgpt_conversations_history_import": {
            "api": "/api/conversations/chatgpt/import-to-hermes",
            "mcp": "pska_chatgpt_conversations_import_to_hermes_history",
            "target": "hermes_conversation_history",
            "control_plane": "hermes_webui_extension",
            "data_plane": "pska",
            "history_owner": "hermes_webui",
            "default_selection": "recent",
            ...
            "embedding_required": False,
            "runtime_special_chatgpt_channel": False,
            "next_step": "ask_normally_in_hermes_and_let_context_pack_query_history",
        },
        "safety": {
