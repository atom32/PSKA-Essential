...
M23 Memory Card refresh-review queue surfacing。
...
| Memory Card Maintenance | 已支持 card/health/briefing/review queue，可从 card 创建 refresh-review，并将其作为 `refresh_reviews` 单独排队 |
