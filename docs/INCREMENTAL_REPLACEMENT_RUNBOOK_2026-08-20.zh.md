...
- long core demo：`188.6s`，`1280x720`，无音轨，10 段纯中文字幕。
- finance case：`148.2s`，`1280x720`，无音轨，10 段纯中文字幕。
- webnovel case：`148.9s`，`1280x720`，无音轨，10 段纯中文字幕；Eidolia 镜头保留
  `23.6s`，展示想法/产物两类节点与续写草稿。
- customer walkthrough：`325.4s`，`1280x720`，无音轨，10 段纯中文字幕；客户主片交付包
  包含入口页、交付摘要、硬字幕版视频、字幕、旁白稿、纯旁白文本、预览图、分镜、清单和说明；
  可选有声预览版 `325.4s`，包含视频流和中文机器旁白音轨。
